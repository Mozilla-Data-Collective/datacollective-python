...
To publish a compensated dataset instead of a free one, set `isPaid=True` and a `basePriceCents` price in **USD cents** (between `10_000` = $100 and `5_000_000` = $50,000). See [Pricing](upload.md#pricing) for details.
